<?php
	...
	$result_array = $DbUtil->query_dhcp_lease_all( 1000 );
	if( count( $result_array ) == 0 ) {
		$out_result = $nm_web_interface->create_error_message( "KAYIT BULUNAMADI" , "Lease tablosunda herhangi bir kayýt bulunamadý !!!" );
		print $out_result;
		die();
	}
