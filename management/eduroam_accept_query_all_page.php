<?php
	...
	$result_array = $DbUtil->query_eduroam_accept_all( 1000 );
	if( count( $result_array ) == 0 ) {
		$out_result = $nm_web_interface->create_error_message( "KAYIT BULUNAMADI" , "Accept tablosunda herhangi bir kayýt bulunamadý !!!" );
		print $out_result;
		die();
	}

	$nm_web_interface->setDisplayWindow( "window_result" , "eduroam Accept Query All Result " );
