<?php
	...
	$result_array = $DbUtil->query_eduroam_reject( $eduroamfilter , 1000 );
	if( count( $result_array ) == 0 ) {
		$out_result = $nm_web_interface->create_error_message( "KAYIT BULUNAMADI" , "Reject tablosunda $query_text için herhangi bir kayýt bulunamadý !!!" );
		print $out_result;
		die();
	}
